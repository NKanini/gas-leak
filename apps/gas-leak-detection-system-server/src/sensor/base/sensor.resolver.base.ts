...
export class SensorResolverBase {
  ...
  @graphql.ResolveField(() => [GasLeakAlert], { name: "gasLeakAlerts" })
  async findGasLeakAlerts(
    @graphql.Parent() parent: Sensor,
    @graphql.Args() args: GasLeakAlertFindManyArgs
  ): Promise<GasLeakAlert[]> {
    const results = await this.service.findGasLeakAlerts(parent.id, args);
  ...
  @graphql.ResolveField(() => [MaintenanceLog], { name: "maintenanceLogs" })
  async findMaintenanceLogs(
    @graphql.Parent() parent: Sensor,
    @graphql.Args() args: MaintenanceLogFindManyArgs
  ): Promise<MaintenanceLog[]> {
    const results = await this.service.findMaintenanceLogs(parent.id, args);
